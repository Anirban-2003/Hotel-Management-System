...
public class Checkout extends JFrame implements ActionListener{
    ...
    Checkout() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Image/10.jpg"));
        Image i3 = i1.getImage().getScaledInstance(600, 600,Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i3);
        JLabel l15 = new JLabel(i2);
        l15.setBounds(350,50,400,250);
        add(l15);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b2){
            ...
            try{
                ...
                while (rs.next()){
                    l2.setText(rs.getString("room"));
                    l3.setText(rs.getString("checkintime"));
                }
            }catch (Exception e){
                e.printStackTrace();
            }
            ...
            String query2="update room set availability='Available' where roomnumber= '"+l2.getText()+"'";
            try{
                Conn c =new Conn();
