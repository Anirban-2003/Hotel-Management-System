...
public class AddDrivers extends JFrame implements ActionListener{
    ...
    AddDrivers() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Image/6.jpeg"));
        ...
        try{
            ...
            if(ae.getSource() == b1){
                try{
                    ...
                    String availablity = (String)comboBox_2.getSelectedItem();
                    String location = t3.getText();
                    if (name.equals("")){
                        JOptionPane.showMessageDialog(null, "Car Can't Be Empty");
                        return;
                    }
                    String str = "INSERT INTO driver values('"+name+"','"+age+"','"+gender+"','"+company+"','"+brand+"','"+availablity+"','"+location+"')";
